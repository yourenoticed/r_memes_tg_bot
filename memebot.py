...
def search(message):
    ...
    names = "\n".join(search_result)
    bot.send_message(message.chat.id, names, reply_to_message_id=message.id)
...
def send_help(message):
    bot.send_message(message.chat.id, texts.HELP, reply_to_message_id=message.id)
    
@bot.message_handler(commands=["commands"])
def send_commands(message):
    bot.send_message(message.chat.id, texts.COMMANDS, reply_to_message_id=message.id)
